...
class CreateSuratJalanTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('surat_jalan', function (Blueprint $table) {
            ...
            $table->string('lon_emergency_1')->nullable();
            $table->string('lat_emergency_1')->nullable();
            ...
            $table->string('lon_emergency_2')->nullable();
            $table->string('lat_emergency_2')->nullable();
            ...
            $table->string('lon_emergency_3')->nullable();
            $table->string('lat_emergency_3')->nullable();
            $table->string('emergency_3')->nullable();
            ...
            $table->string('lon_emergency_4')->nullable();
            $table->string('lat_emergency_4')->nullable();
            $table->string('emergency_4')->nullable();
            ...
            $table->string('lon_emergency_5')->nullable();
            $table->string('lat_emergency_5')->nullable();
            $table->string('emergency_5')->nullable();
            ...
            $table->string('lon_emergency_6')->nullable();
            $table->string('lat_emergency_6')->nullable();
            $table->string('emergency_6')->nullable();
            ...
            $table->string('lon_emergency_7')->nullable();
            $table->string('lat_emergency_7')->nullable();
            $table->string('emergency_7')->nullable();
            ...
            $table->string('lon_emergency_8')->nullable();
            $table->string('lat_emergency_8')->nullable();
            $table->string('emergency_8')->nullable();
            ...
            $table->string('lon_emergency_9')->nullable();
            $table->string('lat_emergency_9')->nullable();
            $table->string('emergency_9')->nullable();
